...
int main(void)
{
  ...
  BSP_LCD_DisplayStringAtLine(0, (uint8_t*) "  DSL Project");
  BSP_LCD_DisplayStringAtLine(1, (uint8_t*) "Alphabet Recognition");
  BSP_LCD_DisplayStringAtLine(2, (uint8_t*) "Draw [a-z] :");

//  BSP_LCD_DisplayStringAtLine(19, (uint8_t*) " B22CS068   B22CS045");
//  BSP_LCD_DisplayStringAtLine(19, (uint8_t*) "     B22CS014");
